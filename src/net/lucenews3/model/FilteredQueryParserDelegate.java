...
public class FilteredQueryParserDelegate implements QueryParserDelegate {

	private QueryParserDelegate target;
	
	public FilteredQueryParserDelegate() {
		
	}
	
	public FilteredQueryParserDelegate(QueryParserDelegate target) {
		this.target = target;
	}
