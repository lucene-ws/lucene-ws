...
public class LuceneWebService extends HttpServlet
{
	...
	public void doOptions (LuceneContext c)
		throws ServletException, IOException
	{
	...
	public void doTrace (LuceneContext c)
		throws ServletException, IOException
	{
	...
	public void setPropertiesFromXML (File file)
		throws IOException
	{
		properties = new Properties();
	...
	public void applyDefaults (LuceneRequest req)
		throws IOException
	{
