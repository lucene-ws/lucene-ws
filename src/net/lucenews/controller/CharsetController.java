...
public class CharsetController extends Controller
{
	...
	public static void encode (String charsetName, InputStream in, OutputStream out)
		throws
			...
			IOException, IllegalStateException, MalformedInputException, UnmappableCharacterException, CharacterCodingException
	{
	...
	/**
	 * Encodes the input stream using the encoder provided by the specified charset
	 * and writes the resulting data to the output stream.
	 * 
	 * @param charset the charset providing the desired CharsetEncoder
	 * @param in      the input stream
	 * @param out     the output stream
	...
	/**
	 * Encodes the input stream using the specified charset encoder and writes the
	 * resulting data to the output stream.
	 * 
	 * @param encoder the CharsetEncoder used to encode the input stream
	 * @param in      the input stream
	 * @param out     the output stream
	 * @throws        IOException
	 * @throws        IllegalStateException
	...
	public static void encode (CharsetEncoder encoder, InputStream in, OutputStream out)
		throws IOException, IllegalStateException, MalformedInputException, UnmappableCharacterException, CharacterCodingException
	{
