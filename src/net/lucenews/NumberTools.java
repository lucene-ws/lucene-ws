...
/**
 * org.apache.lucene.document.NumberTools in disguise!
 * 
 * Blatently copied from actual Lucene code, because native
 * code uses radix 32, not 10 as one would expect...
 */
...
public class NumberTools {
    ...
    public static final String MAX_STRING_VALUE = POSITIVE_PREFIX
            + Long.toString(Long.MAX_VALUE, RADIX);
