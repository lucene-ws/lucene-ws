...
public class OpenSearchDescription {
	...
	public static OpenSearchDescription asOpenSearchDescription(
			Document document) {
		...
		for (int i = 0; i < urls.getLength(); i++) {
			description.addUrl(OpenSearchUrl.asOpenSearchUrl((Element) urls
					.item(i)));
		}
		...
		for (int i = 0; i < images.getLength(); i++) {
			description.addImage(OpenSearchImage
