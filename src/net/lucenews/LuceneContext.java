...
public class LuceneContext {
	...
	public LuceneContext(HttpServletRequest request,
	...
	public void setLocalizations(String locale,
			Map<Object, String> localizations) {
		setLocalizations(new Locale(locale), localizations);
	}

	public void setLocalizations(Locale locale,
			Map<Object, String> localizations) {
