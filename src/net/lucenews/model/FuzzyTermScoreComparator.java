...
/**
 * Sorts terms by their boost. If two terms have equal boost, their length of
 * the shared base is compared to the original term. That is, the more
 * consecutive chars equal to the original term, the higher the rank.
 */
public class FuzzyTermScoreComparator implements Comparator {
	private Term term;
	...
	public int compare(Object o1, Object o2) {
		...
		if (f1 == f2) {
			...
			for (int i = 0; i < t.length(); i++) {
				...
				// both terms had different char than the original term...try
				// next
			}
			return 0;
		}
