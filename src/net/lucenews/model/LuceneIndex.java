...
public class LuceneIndex
{
	...
	protected LuceneIndex (File directory)
		throws IOException
	{
	...
	public void putIndexReader (IndexReader reader)
		throws IOException
	{
	...
	public void putIndexWriter (IndexWriter writer)
		throws IOException
	{
	...
	public boolean hasDocument (String identifier)
		throws IOException
	{
	...
	public LuceneDocument[] getDocuments ()
		throws IOException
	{
		IndexReader reader = getIndexReader();
	...
	public void addDocument (LuceneDocument document)
		throws IllegalActionException, InvalidIdentifierException, DocumentAlreadyExistsException, InsufficientDataException, IOException
	{
		if( isReadOnly() )
			throw new IllegalActionException( "Index is read-only." );
	...
	public LuceneDocument removeDocument (LuceneDocument document)
		throws IllegalActionException, DocumentNotFoundException, InsufficientDataException, IOException
	{
	...
	public void updateDocuments (LuceneDocument... documents)
		throws IllegalActionException, InvalidIdentifierException, DocumentsNotFoundException, InsufficientDataException, IOException
	{
		for( int i = 0; i < documents.length; i++ )
	...
	public void guaranteeFreshData ()
		throws IOException
	{
	...
	public String getSummary (LuceneDocument document)
		throws IOException
	{
	...
	public String getTitle (LuceneDocument document)
		throws IOException
	{
	...
	public void guaranteeFreshProperties ()
		throws IOException
	{
		File file = getPropertiesFile();
	...
	public boolean hasUpdated (LuceneDocument document)
		throws IOException
	{
		try
		{
	...
	public Calendar getUpdated (LuceneDocument document, Calendar calendar)
		throws InvalidIdentifierException, DocumentNotFoundException, InsufficientDataException, IOException
	{
	...
	public String getAuthor (LuceneDocument document)
		throws IOException
	{
